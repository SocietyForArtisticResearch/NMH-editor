...
function getState(cm, pos) {
    ...
    for (var i = 0; i < types.length; i++) {
        ...
        if (data === "strong") {
            ...
            ret[data.replace("header", "heading").replace("-", "")] = true;
        }
    }
    return ret;
}
...
function toggleBold(editor) {
    _toggleBlock(editor, "bold", editor.options.blockStyles.bold, undefined);
}
...
function toggleItalic(editor) {
    _toggleBlock(editor, "italic", editor.options.blockStyles.italic, undefined);
}
...
function toggleCodeBlock(editor) {
    ...
    function insertFencingAtSelection(cm, cur_start, cur_end, fenceCharsToInsert) {
        ...
        _replaceSelection(cm, false, [repl_start, repl_end], undefined);
        cm.setSelection({
            line: start_line_sel,
            ch: 0
        }, {
    ...
    var cm = editor.codemirror,
        ...
        is_code = code_type(cm, cur_start.line, line, tok, undefined);
    ...
    if (is_code === "single") {
        ...
        if (cur_start.line !== cur_end.line || cur_start.ch !== cur_end.ch) {
            ...
            if (fencing_line(cm.getLineHandle(cur_start.line))) { // gets a little tricky if cursor is right on a fenced line
                if (code_type(cm, cur_start.line + 1, undefined, undefined, undefined) === "fenced") {
        ...
        if (cur_start.line !== cur_end.line || cur_start.ch !== cur_end.ch) {
            ...
            for (block_start = cur_start.line; block_start >= 0; block_start--) {
                ...
                if (line.text.match(/^\s*$/)) {
                    ...
                    if (code_type(cm, block_start, line, undefined, undefined) !== "indented") {
                        block_start += 1;
                        break;
                    }
                }
            ...
            for (block_end = cur_start.line; block_end < lineCount; block_end++) {
                ...
                if (line.text.match(/^\s*$/)) {
                    ...
                    if (code_type(cm, block_end, line, undefined, undefined) !== "indented") {
                        block_end -= 1;
                        break;
                    }
                }
        ...
        if (no_sel_and_starting_of_line || sel_multi) {
            ...
            _replaceSelection(cm, false, ["`", "`"], undefined);
        }
    }
}
...
function toggleHeadingSmaller(editor) {
    var cm = editor.codemirror;
    _toggleHeading(cm, "smaller", undefined);
}
...
function toggleHeadingBigger(editor) {
    var cm = editor.codemirror;
    _toggleHeading(cm, "bigger", undefined);
}
...
function drawTable(editor) {
    ...
    var stat = getState(cm, undefined);
    var options = editor.options;
    _replaceSelection(cm, stat.table, options.insertTexts.table, undefined);
}
...
function drawHorizontalRule(editor) {
    ...
    var stat = getState(cm, undefined);
    var options = editor.options;
    _replaceSelection(cm, stat.image, options.insertTexts.horizontalRule, undefined);
}
    ...
    autosave() {
        if (RCMDE.isLocalStorageAvailable()) {
            ...
            if (el != null && el != undefined && el.innerHTML != "") {
                ...
                el.innerHTML = "Autosaved: " + h + ":" + mstr + " " + dd;
            }
            ...
            if (typeof status[i] === "object") {
                ...
                if (name === "words") {
                    ...
                    defaultValue = function (el) {
                        ...
                        el.innerHTML = '<i title="click to save now" style="cursor:pointer">Not saved</i>';
