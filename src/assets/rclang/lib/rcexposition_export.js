...
// const md = window.markdownit(); // get markdown library

const md = window.markdownit('commonmark'); // get markdown library
...
class RCText extends RCObject {
     ...
     */
    constructor(name,gridX,gridY,text,width=1,height=1,userClass) {
	super(name,gridX,gridY,width,height,"rctext",userClass);
	...
	if (this.html === undefined) {
	    ...
	    // convert md to html
	    content.innerHTML = md.render(this.text);
	    // add ids to headers
	    for (let i=1; i<7; i++) {
		let headers = content.getElementsByTagName('h'+i);
...
class RCMedia extends RCObject {
     ...
     * @param {number} height - number of cells it spans vertically
     */
    constructor(name,gridX,gridY,url,pxWidth,pxHeight,width=1,height=1,rcClass,userClass) {
	super(name,gridX,gridY,width,height,rcClass,userClass);
	this.url = url;
...
class RCImage extends RCMedia {
     ...
     * @param {string} userClass - optional user CSS class
     */
    constructor(name,gridX,gridY,url,pxWidth,pxHeight,width=1,height=1,userClass) {
	super(name,gridX,gridY,url,pxWidth,pxHeight,width=1,height=1,"rcimage",userClass);
...
class RCPdf extends RCMedia {
     ...
     */
    constructor(name,gridX,gridY,url,pxWidth,pxHeight,width=1,height=1,userClass) {
	super(name,gridX,gridY,url,pxWidth,pxHeight,width=1,height=1,"rcpdf",userClass);
	...
	if (this.html === undefined)  {
	    ...
	    if (this.pxHeight !== undefined) {
	    pdf.setAttribute("height", this.pxHeight);
	    };
	    if (this.pxWidth !== undefined) {
	    pdf.setAttribute("width", this.pxWidth);
	    };
...
class RCSvg extends RCMedia {
     ...
     */
    constructor(name,gridX,gridY,url,pxWidth,pxHeight,width=1,height=1,userClass) {
	super(name,gridX,gridY,url,pxWidth,pxHeight,width=1,height=1,"rcsvg",userClass);
	...
	if (this.html === undefined)  {
	    ...
	    if (this.pxHeight !== undefined) {
		svg.setAttribute("height", this.pxHeight);
	    };
	    if (this.pxWidth !== undefined) {
		svg.setAttribute("width", this.pxWidth);
	    };
...
class RCAudio extends RCMedia {
     ...
     * @param {number} pxHeight - the height in pixels
     */    
    constructor(name,gridX,gridY,url,autoplay,loop,width=1,height=1,userClass,pxWidth,pxHeight) {
	super(name,gridX,gridY,url,pxWidth,pxHeight,width=1,height=1,"rcaudio",userClass);
	...
	if (this.html === undefined)  {
	    ...
	    if (this.pxHeight !== undefined) {
		audio.setAttribute("height", this.pxHeight);
	    };
	    if (this.pxWidth !== undefined) {
		audio.setAttribute("width", this.pxWidth);
	    };
...
class RCVideo extends RCMedia {
     ...
     * @param {number} pxHeight - the height in pixels
     */    
    constructor(name,gridX,gridY,url,autoplay=false,loop=false,width=1,height=1,userClass,pxWidth,pxHeight) {
	super(name,gridX,gridY,url,pxWidth,pxHeight,width=1,height=1,"rcvideo",userClass);
	this.autoplay = autoplay;
	this.loop = loop;
	...
	if (this.html === undefined)  {
	    ...
	    if (this.pxHeight !== undefined) {
		video.setAttribute("height", this.pxHeight);
	    };
	    if (this.pxWidth !== undefined) {
		video.setAttribute("width", this.pxWidth);
	    };
	    let source = document.createElement("source");
	    source.setAttribute("src", this.url);
...
exports.RCText = RCText;
exports.RCWeave = RCWeave;
exports.RCGrid = RCGrid;
exports.RCExposition = RCExposition;
exports.RCImage = RCImage;
